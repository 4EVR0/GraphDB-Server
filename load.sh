...
S3_PRODUCT="$S3_PRODUCT_BASE/$PRODUCT_VERSION/part-00000.csv"
...
S3_CONTAINS="$S3_CONTAINS_BASE/$CONTAINS_VERSION/part-00000.csv"

echo ""
echo "  S3_BATCH=$S3_BATCH"
echo "  S3_PRODUCT=$S3_PRODUCT"
echo "  S3_CONTAINS=$S3_CONTAINS"
echo ""
